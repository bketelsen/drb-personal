                  ...
                  {post.relationships.author.map((author, index) => (
                    <li key={author.slug} className="flex items-center space-x-2">
                      ...
                      <dl key={author.slug} className="text-sm font-medium leading-5 whitespace-nowrap">
                        ...
                        <dd className="text-gray-900 dark:text-gray-100">{author.frontMatter.name}</dd>
                        ...
                        <dd>
                          ...
                          >
                            {author.frontMatter.twitter.replace('https://twitter.com/', '@')}
                          </Link>
                        </dd>
                      </dl>
                    </li>
                    ...
                    {prev && (
                      <div>
                        ...
                        <div className="text-blue-500 hover:text-blue-600 dark:hover:text-blue-400">
                          <Link href={`/blog/${prev.slug}`}>{prev.frontMatter.title}</Link>
                        </div>
                      </div>
                    )}
                    {next && (
                      <div>
                        ...
                        <div className="text-blue-500 hover:text-blue-600 dark:hover:text-blue-400">
                          <Link href={`/blog/${next.slug}`}>{next.frontMatter.title}</Link>
                        </div>
                      </div>
                    )}
                  </div>
